...
export default function () {
  // 每20分钟爬取一次IP池
  // */20 * * * *
  // const IPTask = schedule.scheduleJob('*/5 * * * *', async function () {
  ...
  //   // 获取ipPool
  //   console.log('获取ipPool')
  //   await getIpPool()
  // }), 0)

  const params = {
    startPage: 1, endPage: 150, speed: 1, marriage: 1, education: 30, area: ["上海","江苏","山西","河北","天津","北京","内蒙古","辽宁","吉林","黑龙江","浙江","安徽","福建","江西","山东","河南","湖北","湖南","广东","广西","海南","重庆","四川","贵州","云南","西藏","陕西","甘肃","青海","宁夏","新疆","台湾","香港","澳门","美国","国外"
    ]
  }
  // 30 1 20 * * *
  // 每天的晚上8点1分30秒触发 常规爬150
  const ListTaskE = schedule.scheduleJob('1 * * * *', async function () {
